		...
		<>
			...
			<div className="relative">
				...
				<div className="absolute z-10 w-full">
					<div className="px-4 text-center pt-36">
						<section className="flex flex-col items-center w-full min-h-screen">
							<h1 className="max-w-4xl text-4xl font-bold text-gray-700 md:text-5xl lg:text-6xl">
								The Easiest Way to{' '}
							...
							/>
							<div className="pt-12"></div>
							<div className="flex flex-col items-center gap-2 text-sm sm:flex-row sm:gap-5 md:text-xl">
						...
						<section className="flex flex-col items-center justify-center min-h-screen gap-2">
							...
							<div className="flex items-center gap-4 p-2 text-lg font-bold bg-gray-100 rounded-lg shadow-lg">
								...
								<div className="flex w-24 h-11 border-[2px] border-gray-600 rounded-full overflow-hidden">
									<Link href="/computer?ai=easy">
										<a className="w-1/2 h-full cursor-pointer lightTileColor"></a>
									</Link>
									<Link href="/computer?ai=easy&asBlack=1">
										<a className="w-1/2 h-full cursor-pointer darkTileColor"></a>
									</Link>
								</div>
							</div>
							<div className="flex items-center gap-4 p-2 text-lg font-bold bg-gray-100 rounded-lg shadow-lg">
